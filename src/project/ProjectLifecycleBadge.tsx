 ...
 *   - "Ends in N days" / "Last day" (yellow) — within 30 days of end_date
 *
 * Every count runs to the last day of access, which is the day before the end
 * date — see the end-dates-are-exclusive note in @/core/dateUtils.
 *
